                                        ...
                                        <tbody>
                                            @foreach($payRequests as $key => $transaction)
                                                <tr>
                                                    ...
                                                    <td class="d-flex">
                                                        <a href="{{route('amount.request',[$transaction->id,1])}}" class="btn bg-light-primary border border-1 border-primary common-lbl-radius text-white btn-sm me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Approve') }}">
                                                            <i class="ti ti-check"></i>
                                                        </a>
                                                        <a href="{{route('amount.request',[$transaction->id,0])}}" class="btn bg-light-danger border border-1 border-danger common-lbl-radius text-white btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Reject') }}">
                                                        <i class="ti ti-x"></i>
                                                        </a>
                                                    </td>
                                                </tr>
