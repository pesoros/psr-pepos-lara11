    ...
    @if (Auth::user()->type == 'super admin')
        ...
        (isset($admin_payments_setting['is_xendit_enabled']) && $admin_payments_setting['is_xendit_enabled'] == 'on')
            ...
            <div class="pr-2 action-btn-wrapper">
                <a class="btn btn-sm btn-icon  btn-primary me-2 text-white" data-url="{{ route('plans.create') }}" data-title="{{ __('Add Plan') }}" data-ajax-popup="true" data-size="lg" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Add Plan') }}">
                                ...
                                @if (\Auth::user()->type != 'super admin')
                                    ...
                                    @else
                                        @if (
                                            ...
                                            <div class="{{ $plan->id == 1 ? 'col-auto' : 'col-auto' }} p-0">
                                                ...
                                                <div class="d-flex action-btn-wrapper">
                                                    ...
                                                    @if($order->payment_status == 'pending' && $order->payment_type == 'Bank Transfer')
                                                        <div class="action-btn ms-2">
                                                            <a href="#" class="mx-3 btn btn-sm btn-icon bg-secondary text-white align-items-center"
