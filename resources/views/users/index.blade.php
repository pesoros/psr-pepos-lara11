...
<div class="action-btn-wrapper">
    <a class="btn btn-sm btn-icon text-light btn-primary" data-url="{{ route('users.create') }}" data-title="{{ __('Add User') }}" data-ajax-popup="true" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Create') }}">
...
@section('content')
    <div class="row">
                        ...
                        @if (Gate::check('Edit User') || Gate::check('Delete User'))
                            <div class="card-header-right">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    @can('Edit User')
                                        <a href="#" class="dropdown-item" data-url="{{ route('users.edit', $user->id) }}" data-size="md" data-ajax-popup="true" data-title="{{ __('Update User') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Edit User') }}">
                                            <i class="ti ti-pencil "></i>
                                            <span class="ms-2">{{ __('Edit') }}</span>
                                        </a>
                                    @endcan
                                    @can('Reset Password')
                                        <a href="#" class="dropdown-item" data-url="{{ route('users.reset', \Crypt::encrypt($user->id)) }}" data-ajax-popup="true" data-size="md" data-title="{{ __('Change Password') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Change Password') }}">
                                            <i class="ti ti-key"></i>
                                    ...
                                    @if ($user->is_enable_login == 1)
                                        <a href="{{ route('owner.users.login', \Crypt::encrypt($user->id)) }}"
                                            class="dropdown-item" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Login Disable') }}">
                                    ...
                                    @elseif ($user->is_enable_login == 0 && $user->password == null)
                                        <a href="#" data-url="{{ route('users.reset', \Crypt::encrypt($user->id)) }}"
                                            ...
                                            data-title="{{ __('New Password') }}" class="dropdown-item" data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    @else
                                        <a href="{{ route('owner.users.login', \Crypt::encrypt($user->id)) }}"
                                            class="dropdown-item" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Login Enable') }}">
                                            <i class="ti ti-road-sign"></i>
                                            <span class="text-success"> {{ __('Login Enable') }}</span>
                                        </a>
                                    @endif
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 col-md-6 create-user-card">
            @can('Create User')
                <a class="btn-addnew-project border-primary" data-url="{{ route('users.create') }}" data-title="{{ __('Add User') }}" data-ajax-popup="true">
